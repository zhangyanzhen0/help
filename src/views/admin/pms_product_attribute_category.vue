<template>
  <div class="root">
    ...
    <el-table :data="paginatedData"
      ...
      <el-table-column prop="attributeCount"
                       label="attributeCount"></el-table-column>
      <el-table-column prop="name"
                       label="name"></el-table-column>
      <el-table-column prop="paramCount"
                       label="paramCount"></el-table-column>
    ...
    <el-dialog class="form"
      ...
      <el-form>
        ...
        <el-form-item label="attributeCount">
          <el-input v-model="editItem.attributeCount"></el-input>
        </el-form-item>
        ...
        <el-form-item label="paramCount">
          <el-input v-model="editItem.paramCount"></el-input>
        </el-form-item>
...
<script>
import api from '@/http/pms_product_attribute_category.js'
import {
  ElMessage,
  ElMessageBox,
  roleTypes
