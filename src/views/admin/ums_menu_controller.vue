<template>
  <div class="root">
    ...
    <el-table :data="paginatedData" :header-cell-style="{
      ...
      <el-table-column  prop="fhidden" label="前端隐藏"></el-table-column>
      <el-table-column  prop="icon" label="前端图片"></el-table-column>
    ...
    <el-dialog class="form" v-model="editDialogVisible" @close="editDialogVisible = false">
      <el-form>
        ...
        <el-form-item label="createTime">
          <el-input-number v-model="editItem.createTime"></el-input-number>
        </el-form-item>
        <el-form-item label="hidden">
          <el-input-number v-model="editItem.hidden"></el-input-number>
        </el-form-item>
...
<script>
import api from '@/http/ums_menu_controller.js'
import {
  ElMessage,
  ElMessageBox,
  roleTypes
