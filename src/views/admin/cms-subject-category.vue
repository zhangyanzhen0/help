<template>
    <div class="root">
        ...
        <el-table :data="paginatedData" :header-cell-style="{
            ...
            <el-table-column prop="subjectCount" label="subjectCount"></el-table-column>
        ...
        <el-dialog class="form" v-model="editDialogVisible" @close="editDialogVisible = false">
            <el-form>
                ...
                <el-form-item label="subjectCount">
                    <el-input v-model="editItem.subjectCount"></el-input>
                </el-form-item>
...
<script>
import api from '@/http/cms-subject-category.js'
import {
    ElMessage,
    ElMessageBox,
    roleTypes
