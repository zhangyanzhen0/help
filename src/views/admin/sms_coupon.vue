  ...
  <div class="root">
    ...
    >
      ...
      <el-table-column
        ...
        label="memberLevel"
      ></el-table-column>
      <el-table-column prop="minPoint" label="minPoint"> </el-table-column>
      <el-table-column prop="note" label="note"></el-table-column>
      <el-table-column prop="perLimit" label="perLimit"></el-table-column>
      <el-table-column
        width="100rpx"
        prop="platform"
        label="platform"
    ...
    >
      <el-form>
        ...
        <el-form-item label="amount">
          <el-input-number vcmodel="editItem.amount"></el-input-number>
        </el-form-item>

        <el-form-item label="code">
          <el-input v-model="editItem.code"></el-input>
        </el-form-item>

        <el-form-item label="count">
          <el-input v-model="editItem.count"></el-input>
        </el-form-item>
        <el-form-item label="enableTime">
          <el-input v-model="editItem.enableTime"></el-input>
        </el-form-item>

        <el-form-item label="endTime">
          <el-input v-model="editItem.endTime"></el-input>
        </el-form-item>
        <el-form-item label="memberLevel">
          <el-input v-model="editItem.memberLevel"></el-input>
        </el-form-item>
        <el-form-item label="minPoint">
          <el-input v-model="editItem.minPoint"></el-input>
        </el-form-item>
        <el-form-item label="note">
          <el-input v-model="editItem.note"></el-input>
        </el-form-item>
        <el-form-item label="perLimit">
          <el-input v-model="editItem.perLimit"></el-input>
        </el-form-item>
        <el-form-item label="platform">
          <el-input v-model="editItem.platform"></el-input>
        </el-form-item>
        <el-form-item label="publishCount">
          <el-input v-model="editItem.publishCount"></el-input>
        </el-form-item>
        <el-form-item label="receiveCount">
          <el-input v-model="editItem.receiveCount"></el-input>
        </el-form-item>
        ...
        <el-form-item label="useCount">
          <el-input v-model="editItem.useCount"></el-input>
        </el-form-item>
        <el-form-item label="useType">
          <el-input v-model="editItem.useType"></el-input>
        </el-form-item>
      </el-form>
...
<script>
import api from "@/http/sms_coupon.js";
