      ...
      <el-table :data="list"
        ...
        <el-table-column fixed="right"
          ...
          <template #default="scope">
            ...
            <el-button type="text"
                       size="small"
                       @click="updateButton(scope.row)">编辑</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    ...
    <el-dialog title="添加退货原因"
      ...
      <el-form :model="returnReason"
        ...
        <el-form-item label="原因类型：">
          <el-input v-model="returnReason.name"
                    class="input-width"></el-input>
        </el-form-item>
        <el-form-item label="排序：">
          <el-input v-model="returnReason.sort"
                    class="input-width"></el-input>
        </el-form-item>
...
import reasonApi from '@/http/oms_order_return_reason.js'
  ...
  methods: {
    ...
    getList () {
      reasonApi.getReasonList(this.listArg).then(resonse => {
        // console.log(resonse)
        this.list = resonse.data.data.page.records
        this.total = resonse.data.data.page.total
