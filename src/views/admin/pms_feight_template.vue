	...
	<div class="root">
		...
		<el-table :data="paginatedData" :header-cell-style="
      {
        ...
        color: '#606266'
			...
			<el-table-column prop="continmeFee" label="continmeFee"></el-table-column>
			<el-table-column prop="continueWeight" label="continueWeight"></el-table-column>
			<el-table-column prop="dest" label="dest"></el-table-column>
			<el-table-column prop="firstFee" label="firstFee"></el-table-column>
			<el-table-column prop="firstWeight" label="firstWeight"></el-table-column>
