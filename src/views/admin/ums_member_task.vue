<template>
  <div class="root">
    ...
    <el-table :data="paginatedData" :header-cell-style="{
      ...
      <el-table-column prop="growth" label="growth"></el-table-column>
      <el-table-column prop="id" label="id"></el-table-column>
      <el-table-column prop="intergration" label="intergration"></el-table-column>
    ...
    <el-dialog class="form" v-model="editDialogVisible" @close="editDialogVisible = false">
      <el-form>
        ...
        <el-form-item label="growth">
          <el-input v-model="editItem.growth" ></el-input>
        </el-form-item>

   
        <el-form-item label="intergration">
          <el-input v-model="editItem.intergration"></el-input>
        </el-form-item>
...
<script>
import api from '@/http/ums_member_task.js'
import {
  ElMessage,
  ElMessageBox,
  roleTypes
