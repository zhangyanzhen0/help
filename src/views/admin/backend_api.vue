  ...
  <div>
    <el-table :data="paginatedData"
      ...
      <el-table-column prop="pid"
                       label="父级ID"></el-table-column>
      <el-table-column prop="apiName"
                       label="API名称"></el-table-column>
      <el-table-column prop="apiUrl"
                       label="API地址"></el-table-column>
      <el-table-column prop="description"
                       label="描述"></el-table-column>
      <el-table-column prop="apiMethod"
                       label="请求方法"></el-table-column>
      <el-table-column prop="hasChildren"
                       label="是否有子级"></el-table-column>
    ...
    <el-dialog v-model="editDialogVisible"
               ...
               center
               width="50%">
      <el-form :model="editedAPI"
               label-width="100px">

        <el-form-item label="id">
          <el-input v-model="editedAPI.id"
                    disabled></el-input>
        </el-form-item>
        ...
        <el-form-item label="是否有子级">
          <el-switch v-model="editedAPI.hasChildren"
                     active-color="#409EFF"
