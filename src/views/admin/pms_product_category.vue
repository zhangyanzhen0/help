<template>
  <div class="root">
    ...
    <el-table :data="paginatedData" :header-cell-style="{
      ...
      <el-table-column prop="navStatus" label="navStatus"></el-table-column>
      <el-table-column prop="parentId" label="parentId"></el-table-column>
      <el-table-column prop="productCount" label="productCount"> </el-table-column>
      <el-table-column prop="productUnit" label="productUnit"></el-table-column>
    ...
    <el-dialog class="form" v-model="editDialogVisible" @close="editDialogVisible = false">
      <el-form>
        ...
        <el-form-item label="id">
          <el-input-number v-model="editItem.id"></el-input-number>
        </el-form-item>
        ...
        <el-form-item label="level">
          <el-input v-model="editItem.level"></el-input>
        </el-form-item>
        ...
        <el-form-item label="navStatus">
          <el-input v-model="editItem.navStatus"></el-input>
        </el-form-item>

        <el-form-item label="parentId">
          <el-input v-model="editItem.parentId"></el-input>
        </el-form-item>
        ...
        <el-form-item label="productUnit">
          <el-input v-model="editItem.productUnit"></el-input>
        </el-form-item>
...
<script>
import api from '@/http/pms_product_category.js'
import {
  ElMessage,
  ElMessageBox,
  roleTypes
