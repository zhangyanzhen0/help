<template>
    <div class="root">
        ...
        <el-table :data="paginatedData" :header-cell-style="{
            ...
            <el-table-column prop="name" label="收发货人姓名"></el-table-column>
            ...
            <el-table-column prop="receiveStatus" label="是否默认收货地址：0->否；1->是"></el-table-column>
            <el-table-column prop="sendStatus" label="默认发货地址：0->否；1->是"></el-table-column>
        ...
        <el-dialog class="form" v-model="editDialogVisible" @close="editDialogVisible = false">
            <el-form>
                ...
                <el-form-item label="addressName">
                    <el-input v-model="editItem.addressName"></el-input>
                </el-form-item>
                ...
                <el-form-item label="region">
                    <el-input v-model="editItem.region"></el-input>
                </el-form-item>

                <el-form-item label="detailAddress">
                    <el-input v-model="editItem.detailAddress"></el-input>
                </el-form-item>

                <el-form-item label="receiveStatus">
                    <el-input v-model="editItem.receiveStatus"></el-input>
                </el-form-item>

                <el-form-item label="sendStatus">
                    <el-input v-model="editItem.sendStatus"></el-input>
                </el-form-item>
...
<script>
import api from '@/http/oms_company_address.js'
import {
    ElMessage,
    ElMessageBox,
    roleTypes
