  ...
  <div class="root">
    ...
    >
      ...
      <el-table-column
        ...
        label="reportStatus"
      ></el-table-column>
      <el-table-column prop="reportType" label="reportType"></el-table-column>
    ...
    >
      <el-form>
        ...
        <el-form-item label="handleStatus">
          <el-input v-model="editItem.handleStatus"></el-input>
        </el-form-item>
        <el-form-item label="note">
          <el-input v-model="editItem.note"></el-input>
        </el-form-item>
        <el-form-item label="reportMemberName">
          <el-input v-model="editItem.reportMemberName"></el-input>
        </el-form-item>
        <el-form-item label="reportObject">
          <el-input v-model="editItem.reportObject"></el-input>
        </el-form-item>
        <el-form-item label="reportStatus">
          <el-input v-model="editItem.reportStatus"></el-input>
        </el-form-item>
        <el-form-item label="reportType">
          <el-input v-model="editItem.reportType"></el-input>
        </el-form-item>
      </el-form>
...
<script>
import api from "@/http/cms_member_report.js";
