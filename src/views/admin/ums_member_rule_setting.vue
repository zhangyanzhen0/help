<template>
  <div class="root">
    ...
    <el-table :data="paginatedData" :header-cell-style="{
      ...
      <el-table-column prop="consumePerPoint" label="consumePerPoint"></el-table-column>
      <el-table-column prop="continueSignDay" label="continueSignDay"></el-table-column>
      <el-table-column prop="continueSignPoint" label="continueSignPoint"></el-table-column>
      <el-table-column prop="lowOrderAmount" label="lowOrderAmount"></el-table-column>
      <el-table-column prop="maxPointPerOrder" label="maxPointPerOrder"></el-table-column>
    ...
    <el-dialog class="form" v-model="editDialogVisible" @close="editDialogVisible = false">
      <el-form><el-form-item label="id" disabled>
          <el-input v-model="editItem.id">
          </el-input>
        </el-form-item>

        <el-form-item label="consumePerPoint">
          <el-input v-model="editItem.consumePerPoint"></el-input>
        </el-form-item>

        <el-form-item label="continueSignDay">
          <el-input v-model="editItem.continueSignDay"></el-input>
        </el-form-item>

        <el-form-item label="continueSignPoint">
          <el-input v-model="editItem.continueSignPoint"></el-input>
        </el-form-item>

        <el-form-item label="lowOrderAmount">
          <el-input v-model="editItem.lowOrderAmount"></el-input>
        </el-form-item>

        <el-form-item label="maxPointPerOrder">
          <el-input v-model="editItem.maxPointPerOrder"></el-input>
        </el-form-item>
...
<script>
import api from '@/http/ums_member_rule_setting.js'
import {
  ElMessage,
  ElMessageBox,
  roleTypes
