<template>
	<div class="root">
		<el-input v-model="searchText" placeholder="请输入搜索关键字" clearable @clear="clearSearch"
			@keyup.enter="performSearch" style="margin-bottom: 20px;"></el-input>
		...
		<el-table :data="paginatedData" :header-cell-style="
      {
        ...
        color: '#606266'
			...
			<el-table-column width="60rpx" prop="id" label="id"></el-table-column>
			<el-table-column width="100rpx" prop="name" label="会员名"></el-table-column>
			<el-table-column width="100rpx" prop="growthPoint" label="成长点"></el-table-column>
			<el-table-column width="100rpx" prop="defaultStatus" label="默认等级"></el-table-column>
			<el-table-column width="100rpx" prop="freeFreightPoint" label="免运费标准"></el-table-column>
			<el-table-column width="100rpx" prop="commentGrowthPoint" label="评价成长值"></el-table-column>
			<el-table-column width="100rpx" prop="priviledgeFreeFreight" label="免邮特权"></el-table-column>
			<el-table-column width="100rpx" prop="priviledgeSignIn" label="签到特权"></el-table-column>
			<el-table-column prop="priviledgeComment" label="评论奖励特权"> </el-table-column>
			<el-table-column prop="priviledgePromotion" label="专项活动特权"></el-table-column>
			<el-table-column prop="priviledgeMemberPrice" label="会员价格特权"></el-table-column>
			<el-table-column width="100rpx" prop="priviledgeBirthday" label="生日特权"></el-table-column>
