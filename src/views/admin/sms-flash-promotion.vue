<template>
    <div>
        ...
        <el-table :data="paginatedData" :header-cell-style="{
            ...
            <el-table-column prop="startDate" label="startDate"></el-table-column>
        ...
        <el-dialog class="form" v-model="editDialogVisible" @close="editDialogVisible = false">
            <el-form>
                ...
                <el-form-item label="startDate">
                    ...
                    <el-input v-model="editItem.startDate"></el-input>

                </el-form-item>

                <el-form-item label="status">
                    <el-input-number v-model="editItem.status"></el-input-number>
                </el-form-item>
                ...
                <el-form-item label="endDate">
                    <el-input v-model="editItem.endDate"></el-input>
                </el-form-item>
            </el-form>
...
<script>
import api from '@/http/sms_flash_promotion.js'
