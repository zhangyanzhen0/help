<template>
    <div class="root">
      ...
      <el-table :data="paginatedData"
                ...
                <el-table-column prop="bigPic" label="专区大图">
                  <template #default="{row}">
              <img :src="row.bigPic" width="200" height="300">
              </template>
                </el-table-column>
            <el-table-column prop="brandStory" label="品牌故事"></el-table-column>
            <el-table-column prop="factoryStatus" label="是否为品牌制造商:0->不是;1->是"></el-table-column>
            <el-table-column prop="firstLetter" label="首字母"></el-table-column>
            <el-table-column prop="id" label="id"></el-table-column>
            <el-table-column prop="logo" label="品牌logo">
              <template #default="{row}">
              <img :src="row.logo" width="150" height="120" >
              </template>
            </el-table-column>
      ...
      <el-dialog class="form"
        ...
        <el-form>
          <el-form-item label="bigPic">
            <el-input v-model="editItem.bigPic"></el-input>
          </el-form-item>
  
          <el-form-item label="brandStory">
            <el-input v-model="editItem.brandStory"></el-input>
          </el-form-item>
  
          <el-form-item label="factoryStatus">
            <el-input v-model="editItem.factoryStatus"></el-input>
          </el-form-item>
  
          <el-form-item label="firstLetter">
            <el-input v-model="editItem.firstLetter"></el-input>
          </el-form-item>
          ...
          <el-form-item label="logo">
            <el-input v-model="editItem.logo"></el-input>
          </el-form-item>
          ...
          <el-form-item label="productCommentCount">
            <el-input v-model="editItem.productCommentCount"></el-input>
          </el-form-item>

          <el-form-item label="productCount">
            <el-input v-model="editItem.productCount"></el-input>
          </el-form-item>

          <el-form-item label="showStatus">
  ...
  <script>
  import api from '@/http/pms_brand.js'
  import {
    ElMessage,
    ElMessageBox,
    roleTypes
