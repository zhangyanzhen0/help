  ...
  <div class="root">
    ...
    <el-table :data="paginatedData"
      ...
      <el-table-column prop="showStatus"
                       label="showStatus"></el-table-column>
    ...
    <el-dialog class="form"
      ...
      <el-form >
        ...
        <el-form-item label="pic">
          <el-input-number v-model="editItem.pic"></el-input-number>
        </el-form-item>

        <el-form-item label="showStatus">
          <el-input-number v-model="editItem.showStatus"></el-input-number>
        </el-form-item>
        ...
        <el-form-item label="subTitle">
          <el-input v-model="editItem.subTitle"></el-input>
        </el-form-item>
